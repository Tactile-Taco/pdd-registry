"""Pure-python SHA-256 (local helper module; attested with the bundle core).

The validator's import allowlist has no hashlib, so the candidate core needs
its own deterministic hash implementation. Tests cross-check against hashlib.
"""
